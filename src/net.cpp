...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nhucoin " + FormatFullVersion();
...
//    {"nhucointools.com", "dnsseed.nhucointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
//    {"nhucointools.com", "testnet-seed.nhucointools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nhucoin is probably already running."), addrBind.ToString().c_str());
        else
